...
<table class="tmain g_w">
    ...
    <tr>
        ...
        <td style="text-align:left;">
            <strong><a style="color:#000;" ajax="true" href="/admin/category/add?cid={$item['cid']}">{$item['category_name']}</a></strong>&nbsp;|
            {foreach from=$item['sub'] item=sitem}
            &nbsp;<a style="color:#000;" ajax="true" href="/admin/category/add?cid={$sitem['cid']}">{$sitem['category_name']}</a>
            {/foreach}
        </td>
    </tr>
    {/foreach}
