...
if($sKey!=$_POST['key']){
    echo '<script type="text/javascript">alert("请刷新页面后重试");</script>';
    ...
    echo '<script type="text/javascript">parent.$("#error_box").show();parent.$("#error_tip").html("文件不能大于2M");</script>';
}
 */
...
$torrent->announce(false); // 清除 announce trackers
$torrent->announce(array('http://torrent.tracker/annonce', 'http://alternate-torrent.tracker/annonce')); // 设置多个 tracker, 支持单个 tracker 的 Array (数组)...
$torrent->announce(array(array('http://torrent.tracker/annonce', 'http://alternate-torrent.tracker/annonce'), 'http://another-torrent.tracker/annonce')); // 设置多级 trackers
...
* </code>
*
* @作者     Adrien Gibrat <adrien.gibrat@gmail.com>
* @测试人员 Jeong, Anton, dokcharlie, official testers ;) 感谢你们宝贵的意见
* @CopyLeft 2010 - Just use it!
* @许可     http://www.gnu.org/licenses/gpl.html GNU 通用公共许可证 version 3
* @版本     Release: 1.2 (6 july 2010)
 */
